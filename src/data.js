...
export const projects = [
  {
    ...
    highlights: [
      "Nginx-balanced FastAPI tier with Redis cache-aside (p99 < 1.5 ms)",
      "Collision-free short codes via PostgreSQL sequence + Feistel cipher",
      "Async analytics via RabbitMQ with competing consumers and DLQ",
    ],
  ...
  },
  {
    ...
    highlights: [
      "6-state complaint lifecycle with auto-escalation on SLA breach",
      "Background cron service that auto-flags stale complaints",
      "Deployed on Vercel + Render + Clever Cloud behind JWT auth",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "Interactive Streamlit UI with conversational Q&A",
    ],
  ...
  },
  {
    ...
    highlights: [
      "3-tier hierarchical network simulation with real-time visualization",
